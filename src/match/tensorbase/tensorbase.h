...
typedef enum
{
    ...
    TB_MALLOC_ERROR,
    TB_NULL_INPUT_ERROR,
    TB_INCOMPATABLE_BROASCAST_SHAPES_ERROR,
    TB_INVALID_DIMENSION_SIZE_ERROR,
    TB_DUPLICATE_DIMENSION_ERROR,
    TB_INVALID_NDIM_ERROR,
    TB_NOT_IMPLEMENTED_ERROR,
    TB_MATMUL_WITH_SINGLETON_OPERAND_ERROR,
    TB_MATMUL_INCOMPATABLE_SHAPES_ERROR,
    TB_SHAPE_MISMATCH_ERROR,
    TB_ELEMENT_COUNT_NOT_ONE_ERROR,
    TB_INDEX_OUT_OF_BOUNDS_ERROR,
    TB_DIMENSION_OUT_OF_BOUNDS_ERROR
} StatusCode;
